...
package com.fvslnlqb.chat.features.link
...
import com.fvslnlqb.chat.databinding.ActivityProgressBinding
...
class LinkHandlerActivity : VectorBaseActivity<ActivityProgressBinding>() {
    ...
    private fun handleIntent() {
        ...
        when {
            ...
            resources.getStringArray(com.fvslnlqb.chat.config.R.array.permalink_supported_hosts).contains(uri.host) -> handleSupportedHostUrl()
            else -> {
