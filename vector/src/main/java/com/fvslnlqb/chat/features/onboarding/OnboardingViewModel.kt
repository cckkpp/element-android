...
import com.fvslnlqb.chat.core.extensions.cancelCurrentOnSet
import com.fvslnlqb.chat.core.extensions.inferNoConnectivity
import com.fvslnlqb.chat.core.extensions.isMatrixId
...
import com.fvslnlqb.chat.features.login.HomeServerConnectionConfigFactory
...
import com.fvslnlqb.chat.features.onboarding.OnboardingAction.AuthenticateAction
...
class OnboardingViewModel @AssistedInject constructor(
    ...
    private val matrixOrgUrl = stringProvider.getString(com.fvslnlqb.chat.config.R.string.matrix_org_server_url).ensureTrailingSlash()
