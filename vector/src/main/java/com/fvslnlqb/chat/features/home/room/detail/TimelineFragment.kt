...
import com.fvslnlqb.chat.core.animations.play
import com.fvslnlqb.chat.core.dialogs.ConfirmationDialogBuilder
import com.fvslnlqb.chat.core.dialogs.GalleryOrCameraDialogHelper
import com.fvslnlqb.chat.core.dialogs.GalleryOrCameraDialogHelperFactory
import com.fvslnlqb.chat.core.epoxy.LayoutManagerStateRestorer
import com.fvslnlqb.chat.core.extensions.cleanup
import com.fvslnlqb.chat.core.extensions.commitTransaction
import com.fvslnlqb.chat.core.extensions.containsRtLOverride
import com.fvslnlqb.chat.core.extensions.ensureEndsLeftToRight
import com.fvslnlqb.chat.core.extensions.filterDirectionOverrides
...
import com.fvslnlqb.chat.core.glide.GlideRequests
import com.fvslnlqb.chat.core.intent.getFilenameFromUri
import com.fvslnlqb.chat.core.intent.getMimeTypeFromUri
import com.fvslnlqb.chat.core.platform.VectorBaseFragment
import com.fvslnlqb.chat.core.platform.VectorMenuProvider
import com.fvslnlqb.chat.core.platform.showOptimizedSnackbar
import com.fvslnlqb.chat.core.resources.ColorProvider
import com.fvslnlqb.chat.core.resources.UserPreferencesProvider
import com.fvslnlqb.chat.core.ui.views.CurrentCallsView
import com.fvslnlqb.chat.core.ui.views.CurrentCallsViewPresenter
import com.fvslnlqb.chat.core.ui.views.FailedMessagesWarningView
import com.fvslnlqb.chat.core.ui.views.JoinConferenceView
import com.fvslnlqb.chat.core.ui.views.NotificationAreaView
import com.fvslnlqb.chat.core.utils.Debouncer
import com.fvslnlqb.chat.core.utils.DimensionConverter
import com.fvslnlqb.chat.core.utils.KeyboardStateUtils
import com.fvslnlqb.chat.core.utils.PERMISSIONS_FOR_WRITING_FILES
...
import com.fvslnlqb.chat.core.utils.createJSonViewerStyleProvider
import com.fvslnlqb.chat.core.utils.createUIHandler
import com.fvslnlqb.chat.core.utils.isAnimationEnabled
import com.fvslnlqb.chat.core.utils.isValidUrl
import com.fvslnlqb.chat.core.utils.onPermissionDeniedDialog
import com.fvslnlqb.chat.core.utils.openLocation
...
import com.fvslnlqb.chat.core.utils.safeStartActivity
import com.fvslnlqb.chat.core.utils.saveMedia
import com.fvslnlqb.chat.core.utils.shareMedia
import com.fvslnlqb.chat.core.utils.shareText
import com.fvslnlqb.chat.core.utils.startInstallFromSourceIntent
import com.fvslnlqb.chat.core.utils.toast
import com.fvslnlqb.chat.databinding.DialogReportContentBinding
import com.fvslnlqb.chat.databinding.FragmentTimelineBinding
import com.fvslnlqb.chat.features.VectorFeatures
import com.fvslnlqb.chat.features.analytics.extensions.toAnalyticsInteraction
import com.fvslnlqb.chat.features.analytics.plan.Interaction
import com.fvslnlqb.chat.features.analytics.plan.MobileScreen
import com.fvslnlqb.chat.features.attachments.ShareIntentHandler
import com.fvslnlqb.chat.features.call.SharedKnownCallsViewModel
import com.fvslnlqb.chat.features.call.VectorCallActivity
import com.fvslnlqb.chat.features.call.conference.ConferenceEvent
import com.fvslnlqb.chat.features.call.conference.ConferenceEventEmitter
import com.fvslnlqb.chat.features.call.conference.ConferenceEventObserver
...
import com.fvslnlqb.chat.features.crypto.keysbackup.restore.KeysBackupRestoreActivity
import com.fvslnlqb.chat.features.crypto.verification.user.UserVerificationBottomSheet
...
import com.fvslnlqb.chat.features.home.room.detail.composer.CanSendStatus
import com.fvslnlqb.chat.features.home.room.detail.composer.MessageComposerAction
import com.fvslnlqb.chat.features.home.room.detail.composer.MessageComposerFragment
import com.fvslnlqb.chat.features.home.room.detail.composer.MessageComposerViewModel
import com.fvslnlqb.chat.features.home.room.detail.composer.boolean
import com.fvslnlqb.chat.features.home.room.detail.composer.voice.VoiceRecorderFragment
import com.fvslnlqb.chat.features.home.room.detail.error.RoomNotFound
import com.fvslnlqb.chat.features.home.room.detail.timeline.TimelineEventController
import com.fvslnlqb.chat.features.home.room.detail.timeline.action.EventSharedAction
import com.fvslnlqb.chat.features.home.room.detail.timeline.action.MessageActionsBottomSheet
...
import com.fvslnlqb.chat.features.home.room.detail.timeline.item.MessageAudioItem
import com.fvslnlqb.chat.features.home.room.detail.timeline.item.MessageFileItem
import com.fvslnlqb.chat.features.home.room.detail.timeline.item.MessageImageVideoItem
import com.fvslnlqb.chat.features.home.room.detail.timeline.item.MessageInformationData
import com.fvslnlqb.chat.features.home.room.detail.timeline.item.MessageTextItem
import com.fvslnlqb.chat.features.home.room.detail.timeline.item.MessageVoiceItem
import com.fvslnlqb.chat.features.home.room.detail.timeline.item.ReadReceiptData
import com.fvslnlqb.chat.features.home.room.detail.timeline.reactions.ViewReactionsBottomSheet
import com.fvslnlqb.chat.features.home.room.detail.timeline.readreceipts.DisplayReadReceiptsBottomSheet
import com.fvslnlqb.chat.features.home.room.detail.timeline.url.PreviewUrlRetriever
import com.fvslnlqb.chat.features.home.room.detail.upgrade.MigrateRoomBottomSheet
import com.fvslnlqb.chat.features.home.room.detail.views.RoomDetailLazyLoadedViews
import com.fvslnlqb.chat.features.home.room.detail.widget.RoomWidgetsBottomSheet
import com.fvslnlqb.chat.features.home.room.threads.ThreadsManager
import com.fvslnlqb.chat.features.home.room.threads.arguments.ThreadTimelineArgs
import com.fvslnlqb.chat.features.html.EventHtmlRenderer
import com.fvslnlqb.chat.features.invite.VectorInviteView
import com.fvslnlqb.chat.features.location.LocationSharingMode
import com.fvslnlqb.chat.features.location.toLocationData
...
import com.fvslnlqb.chat.features.notifications.NotificationDrawerManager
import com.fvslnlqb.chat.features.notifications.NotificationUtils
import com.fvslnlqb.chat.features.permalink.NavigationInterceptor
import com.fvslnlqb.chat.features.permalink.PermalinkFactory
import com.fvslnlqb.chat.features.permalink.PermalinkHandler
...
import com.fvslnlqb.chat.features.spaces.share.ShareSpaceBottomSheet
import com.fvslnlqb.chat.features.themes.ThemeUtils
import com.fvslnlqb.chat.features.widgets.WidgetActivity
import com.fvslnlqb.chat.features.widgets.WidgetArgs
import com.fvslnlqb.chat.features.widgets.WidgetKind
import com.fvslnlqb.chat.features.widgets.permissions.RoomWidgetPermissionBottomSheet
