...
package com.fvslnlqb.chat.features.raw.wellknown
...
data class E2EWellKnownConfig(
        ...
        /**
         * Configuration for sharing keys strategy which should be used instead of [com.fvslnlqb.chat.config.Config.KEY_SHARING_STRATEGY].
