...
import com.fvslnlqb.chat.core.extensions.hasSurroundingSpaces
...
import com.fvslnlqb.chat.core.extensions.onTextChange
...
import com.fvslnlqb.chat.databinding.FragmentFtueCombinedRegisterBinding
...
class FtueAuthCombinedRegisterFragment :
    ...
    private fun OnboardingViewState.isNumericOnlyUserIdForbidden() =
            selectedHomeserver.userFacingUrl == getString(com.fvslnlqb.chat.config.R.string.matrix_org_server_url)
}
