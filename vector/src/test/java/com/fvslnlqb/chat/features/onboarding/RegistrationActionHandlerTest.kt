...
import com.fvslnlqb.chat.test.fakes.FakeRegistrationWizardActionDelegate
...
import com.fvslnlqb.chat.test.fixtures.SelectedHomeserverStateFixture.aSelectedHomeserverState
...
class RegistrationActionHandlerTest {
    ...
    private val fakeStringProvider = FakeStringProvider().also {
        it.given(com.fvslnlqb.chat.config.R.string.matrix_org_server_url, "https://matrix.org")
    }
